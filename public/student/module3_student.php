...
$query = "SELECT * FROM attendance WHERE sid = {$_SESSION['sid']} AND MOD_ID = 'MOD3'";
...
<div class= "top">
	<h1 style="height: 20px; font-size: large;"> Module 3</h1>
</div>
	
<div class="content1">
	<?php echo "<p style='font-size: larger'> Total Attendance for Module 3: <b>$percentage%</b></p>";
	?> 
