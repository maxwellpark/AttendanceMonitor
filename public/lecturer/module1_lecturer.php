...
// $query = "SELECT * FROM attendance WHERE MOD_ID = 'MOD1'";
...
<div class="content1">
	<p style="font-size: larger;"> Total Attendance for Module 1: 
	<?php echo round($lecturer->moduleTotal($db, $module_id) / 72 * 100) . "%"; ?> </p>
